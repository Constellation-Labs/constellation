...
class BIP44Test extends AnyFreeSpec with Matchers {
  ...
  "BIP44 wallet keys should validate for DAG signature scheme using publickey recovered from id" in {
    val bip44 = new BIP44(seedCode)
    val dagSign = bip44.signData(msg)
    val publicKey = KeyUtils.hexToPublicKey(
      "08dda015c42ea066a52d68e2ab2985b5ab255d3d0fd2b90363548cc74963b156e1a6aec5beb1a0c1df86025ffded1dba91afa87ecacdc6e32934421ab6c28d9e"
    )
  ...
  "Expected private key should be generated from the given mnemonic and depth" in {
    ...
    val expected =
      "677c919bf7f5129c2fa245774e08f8c64be16bf6ef4d9d3fcad570c7a503d8cba00706052b8104000aa1440342000408dda015c42ea066a52d68e2ab2985b5ab255d3d0fd2b90363548cc74963b156e1a6aec5beb1a0c1df86025ffded1dba91afa87ecacdc6e32934421ab6c28d9e"
    val result = KeyUtils.privateKeyToFullHex(privateKey)
