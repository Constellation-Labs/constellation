...
//import org.constellation.schema.schema.snapshot.StoredSnapshot
...
//    )
//    genesis = go()
//    cluster = Cluster[IO](() => dao.metrics, ipManager, new JoiningPeerValidator[IO](dao.apiClient), dao.apiClient, dao)
//    dao.cluster = cluster
