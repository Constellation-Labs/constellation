...
class PeerAPITest
  ...
  "The PeerAPI" - {
     ...
     */
    "should return acknowledge message on finishing checkpoint and reply with callback" ignore {
    ...
    "should return acknowledge message on finishing checkpoint and make no reply with callback" in {
      val req = FinishedCheckpoint(CheckpointCache(None), Set.empty)
