...
import org.constellation.domain.healthcheck.HealthCheckConsensus.{FetchPeerHealthStatus, NotifyAboutMissedConsensus, SendPerceivedHealthStatus}
...
trait HealthCheckClientAlgebra[F[_]] {
  ...
  def fetchPeerHealthStatus(fetchPeerHealtStatus: FetchPeerHealthStatus): PeerResponse[F, Either[FetchProposalError, SendPerceivedHealthStatus]]
