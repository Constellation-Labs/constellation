...
class ConstellationKryoRegistrar extends IKryoRegistrar {
  ...
  def registerClasses(kryo: Kryo): Unit = {
    ...
    kryo.register(classOf[Seq[CheckpointBlockFullData]])
    ...
    kryo.register(classOf[CheckpointCacheFullData])
    ...
    kryo.register(classOf[CheckpointBlockFullData])
    kryo.register(classOf[CheckpointCacheData])
    kryo.register(classOf[CheckpointBlockData])
