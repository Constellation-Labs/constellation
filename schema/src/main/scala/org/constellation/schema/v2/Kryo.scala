...
import org.constellation.schema.v2.address.{Address, AddressCacheData}
...
import org.constellation.schema.v2.observation.{
...
//    kryo.register(classOf[AddressMetaData], 186) // REMOVED CLASS
    ...
    kryo.register(classOf[scalapb.UnknownFieldSet], 250)
  }
}
