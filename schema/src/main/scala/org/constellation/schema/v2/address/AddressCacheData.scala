...
object AddressCacheData
    extends ProtoAutoCodecs[org.constellation.schema.proto.address.AddressCacheData, AddressCacheData] {
  val cmp = org.constellation.schema.proto.address.AddressCacheData
